      ...
      {previewData.map((items: Items) => {
        return (
          <a
            key={items.title}
            href={items.href}
            className="rounded-xl text-lg block my-8 p-4 text-white bg-[#392d35] shadow-md hover:bg-[#5a3f58] transition-colors duration-300 hover:shadow-lg cursor-pointer"
          >
